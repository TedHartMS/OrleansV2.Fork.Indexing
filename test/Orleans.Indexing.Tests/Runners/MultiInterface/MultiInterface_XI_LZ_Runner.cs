...
namespace Orleans.Indexing.Tests.MultiInterface
{
...
#if ALLOW_FT_ACTIVE
    public class FT_Grain_Employee_XI_LZ_PK : TestEmployeeGrain<EmployeeGrainState, FaultTolerantIndexableGrainStateWrapper<EmployeeGrainState>>,
    ...
    public class NFT_Grain_Employee_XI_LZ_PK : TestEmployeeGrain<EmployeeGrainState, IndexableGrainStateWrapper<EmployeeGrainState>>,
...
#if ALLOW_FT_ACTIVE
    public class FT_Grain_Employee_XI_LZ_SB : TestEmployeeGrain<EmployeeGrainState, FaultTolerantIndexableGrainStateWrapper<EmployeeGrainState>>,
    ...
    public class NFT_Grain_Employee_XI_LZ_SB : TestEmployeeGrain<EmployeeGrainState, IndexableGrainStateWrapper<EmployeeGrainState>>,
