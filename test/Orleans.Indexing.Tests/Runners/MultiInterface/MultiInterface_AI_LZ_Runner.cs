...
namespace Orleans.Indexing.Tests.MultiInterface
{
    ...
    public class FT_Grain_Employee_AI_LZ_PK : TestEmployeeGrain<EmployeeGrainState, FaultTolerantIndexableGrainStateWrapper<EmployeeGrainState>>,
                                              IFT_Grain_Person_AI_LZ_PK, IFT_Grain_Job_AI_LZ_PK
    {
    ...
    public class NFT_Grain_Employee_AI_LZ_PK : TestEmployeeGrain<EmployeeGrainState, IndexableGrainStateWrapper<EmployeeGrainState>>,
                                               INFT_Grain_Person_AI_LZ_PK, INFT_Grain_Job_AI_LZ_PK
    {
    ...
    public class FT_Grain_Employee_AI_LZ_PS : TestEmployeeGrain<EmployeeGrainState, FaultTolerantIndexableGrainStateWrapper<EmployeeGrainState>>,
                                              IFT_Grain_Person_AI_LZ_PS, IFT_Grain_Job_AI_LZ_PS
    {
    ...
    public class NFT_Grain_Employee_AI_LZ_PS : TestEmployeeGrain<EmployeeGrainState, IndexableGrainStateWrapper<EmployeeGrainState>>,
                                               INFT_Grain_Person_AI_LZ_PS, INFT_Grain_Job_AI_LZ_PS
    {
    ...
    public class FT_Grain_Employee_AI_LZ_SB : TestEmployeeGrain<EmployeeGrainState, FaultTolerantIndexableGrainStateWrapper<EmployeeGrainState>>,
                                              IFT_Grain_Person_AI_LZ_SB, IFT_Grain_Job_AI_LZ_SB
    {
    ...
    public class NFT_Grain_Employee_AI_LZ_SB : TestEmployeeGrain<EmployeeGrainState, IndexableGrainStateWrapper<EmployeeGrainState>>,
                                               INFT_Grain_Person_AI_LZ_SB, INFT_Grain_Job_AI_LZ_SB
    {
    ...
    public abstract class MultiInterface_AI_LZ_Runner : IndexingTestRunnerBase
    {
        ...
        internal static Func<IndexingTestRunnerBase, int, Task>[] GetAllTestTasks()
        {
            ...
            {
                (baseRunner, intAdjust) => baseRunner.TestEmployeeIndexesWithDeactivations<IFT_Grain_Person_AI_LZ_PK, FT_Props_Person_AI_LZ_PK,
                                                            IFT_Grain_Job_AI_LZ_PK, FT_Props_Job_AI_LZ_PK>(intAdjust),
                (baseRunner, intAdjust) => baseRunner.TestEmployeeIndexesWithDeactivations<INFT_Grain_Person_AI_LZ_PK, NFT_Props_Person_AI_LZ_PK,
                                                            INFT_Grain_Job_AI_LZ_PK, NFT_Props_Job_AI_LZ_PK>(intAdjust),
                (baseRunner, intAdjust) => baseRunner.TestEmployeeIndexesWithDeactivations<IFT_Grain_Person_AI_LZ_PS, FT_Props_Person_AI_LZ_PS,
                                                            IFT_Grain_Job_AI_LZ_PS, FT_Props_Job_AI_LZ_PS>(intAdjust),
                (baseRunner, intAdjust) => baseRunner.TestEmployeeIndexesWithDeactivations<INFT_Grain_Person_AI_LZ_PS, NFT_Props_Person_AI_LZ_PS,
                                                            INFT_Grain_Job_AI_LZ_PS, NFT_Props_Job_AI_LZ_PS>(intAdjust),
                (baseRunner, intAdjust) => baseRunner.TestEmployeeIndexesWithDeactivations<IFT_Grain_Person_AI_LZ_SB, FT_Props_Person_AI_LZ_SB,
                                                            IFT_Grain_Job_AI_LZ_SB, FT_Props_Job_AI_LZ_SB>(intAdjust),
                (baseRunner, intAdjust) => baseRunner.TestEmployeeIndexesWithDeactivations<INFT_Grain_Person_AI_LZ_SB, NFT_Props_Person_AI_LZ_SB,
                                                            INFT_Grain_Job_AI_LZ_SB, NFT_Props_Job_AI_LZ_SB>(intAdjust)
            };
        }
    }
}
