...
namespace Orleans.Indexing.Tests.MultiInterface
{
    ...
    public class NFT_Grain_Employee_XI_EG_PK : TestEmployeeGrain<EmployeeGrainState, IndexableGrainStateWrapper<EmployeeGrainState>>,
    ...
    public class NFT_Grain_Employee_XI_EG_SB : TestEmployeeGrain<EmployeeGrainState, IndexableGrainStateWrapper<EmployeeGrainState>>,
