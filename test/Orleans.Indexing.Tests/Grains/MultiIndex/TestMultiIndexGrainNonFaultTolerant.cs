...
namespace Orleans.Indexing.Tests
{
    ...
    public abstract class TestMultiIndexGrainNonFaultTolerant<TGrainState> : Grain<IndexableGrainStateWrapper<TGrainState>>, ITestMultiIndexGrain
        where TGrainState : class, ITestMultiIndexState, new()
    {
        ...
        public TestMultiIndexGrainNonFaultTolerant(IIndexWriter<TGrainState> indexWriter)
