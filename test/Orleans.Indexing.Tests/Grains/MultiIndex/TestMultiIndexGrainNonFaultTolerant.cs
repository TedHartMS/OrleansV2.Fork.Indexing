...
namespace Orleans.Indexing.Tests
{
    ...
    public abstract class TestMultiIndexGrainNonFaultTolerant<TState, TProps> : IndexableGrainNonFaultTolerant<TState, TProps>, ITestMultiIndexGrain
        where TState : ITestMultiIndexState, new() where TProps : ITestMultiIndexProperties, new()
    {
        ...
        public TestMultiIndexGrainNonFaultTolerant()
        {
