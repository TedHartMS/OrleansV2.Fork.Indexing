...
namespace Orleans.Indexing.Tests
{
    ...
    public abstract class TestIndexGrainNonFaultTolerant<TState, TProps> : IndexableGrainNonFaultTolerant<TState, TProps>, ITestIndexGrain
        where TState : ITestIndexState, new() where TProps : ITestIndexProperties, new()
    {
        ...
        public TestIndexGrainNonFaultTolerant()
        {
