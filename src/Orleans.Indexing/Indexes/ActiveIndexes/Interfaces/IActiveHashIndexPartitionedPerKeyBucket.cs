...
namespace Orleans.Indexing
{
    ...
    [Unordered]
    public interface IActiveHashIndexPartitionedPerKeyBucket<K, V> : IGrainWithStringKey, IHashIndexPartitionedPerKeyBucketInterface<K, V> where V : IIndexableGrain
    {
    }
}
