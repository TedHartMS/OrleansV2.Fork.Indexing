# HelloIndexing.NetCore
Orleans simple Indexing sample targeting .NET Core. There are 4 scenarios illustrated:
- Non-unique indexing (of a single property)
- Unique indexing (of a computed property)
- Intersecting non-unique index results (of single properties)
- Concatenating index results (of single properties)
